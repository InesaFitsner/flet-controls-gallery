...
container_grid_item.examples = [
    ExampleItem(name="Clickable containers", file_name="container/clickable_containers.py"), 
    ExampleItem(name="Containers with different background color", file_name = "container/containers_with_different_background_color.py"), 
    ExampleItem(name="Container alignments", file_name="container/container_alignments.py")
]
